...
import { Download, Printer, Shield, GraduationCap, QrCode, User } from 'lucide-react';
...
export const StudentIdCard: React.FC<StudentIdCardProps> = ({ student, settings }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div
        id={cardId}
        className="max-w-xs mx-auto bg-white rounded-2xl border-2 border-emerald-800 shadow-xl overflow-hidden font-sans text-slate-900 printable-card"
      >
        {/* Card Header */}
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex items-center gap-3">
            <div className="w-20 h-24 rounded-lg overflow-hidden border-2 border-emerald-700 shadow-sm shrink-0 bg-slate-100 flex items-center justify-center">
